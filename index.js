...
//When the counter variable (i) is between the given number and 15, the loop will assign the string: "I love the Beatles!" to each element in the variable: "loveBeatlesArray".
//Once the loop is run, the program will return the new array.
